...
- [`auki-datatypes`](crates/auki-datatypes/README.md) — segment payload schemas for Pinhole cameras, Point Clouds, Audio, and Pose Logs (`SpatialTransform`); the `.proto` files are the cross-language contract
