...
- **libp2p substrate** (TCP/QUIC, Noise, Yamux, Circuit Relay v2) with typed `/auki/stream/0.1.0` streams for camera, point-cloud, joint-encoder, audio, and live pose `SpatialTransform` payloads.
