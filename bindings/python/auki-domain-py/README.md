...
- `ClusterManager.list_clusters(...)`, `ClusterManager.bootstrap(...)`, `ClusterManager.create_cluster(...)`, `ClusterManager.join_cluster(...)`.
...
- `external_addresses` advertisement override.
