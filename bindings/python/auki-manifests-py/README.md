...
PyO3 bindings for [`auki-manifests`](../../../crates/auki-manifests) — pure-function wrappers around the four `build_*_log_manifest` builders. Lets a Python consumer construct SDK-canonical log manifest dicts without re-implementing field shapes.
