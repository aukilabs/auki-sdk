...
pub use super::{AccessBundle, Result, SiweError};
...
/// Derive the existing Node login wallet address from its configured key.
pub fn derive_eth_address(priv_hex: &str) -> anyhow::Result<String> {
