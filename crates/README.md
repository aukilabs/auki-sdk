...
| [`auki-domain-py`](auki-domain-py) | Python daemon facade for `ClusterManager`: bootstrap/create/join, role/membership accessors, peer info/catalog exchange, stream provider and stream openers. |
