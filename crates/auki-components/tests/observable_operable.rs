...
use auki_components::{
    CameraBufferCapture, CameraComponent, ComponentRuntime, InMemoryTransport, InvocationContext,
    InvocationError, ObservationDelivery, ObservationEndReason, ObservationEvent,
    ObservationStatus, PayloadContract, ReseedDriver, SetResolution, observation_input,
};
...
fn resolution_change_replaces_output_not_component() {
    let peer_a = ComponentRuntime::new("peer-a");
