...
Steps 1 and 2 of the [migration sprint](src/sprint.md) landed 2026-05-08:
...
Four on-disk payloads remain (point cloud, audio, pose, time-transform) plus the `placeholder.proto` smoke-test (goes away at Step 7). See [`src/readme.md`](src/readme.md) for the current state and [`src/sprint.md`](src/sprint.md) for the migration sequence.
