...
The five on-disk + three libp2p-wire packages cover every payload type the SDK ships today. Only the `placeholder.proto` smoke-test remains (goes away at Step 7 — bookkeeping). See [`src/readme.md`](src/readme.md) for the current state.
