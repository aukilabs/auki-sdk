...
**The migration is complete.** Steps 1 through 7 of the [migration sprint](src/sprint.md) landed 2026-05-08:
...
The five on-disk and three libp2p-wire packages cover every payload type the SDK ships. See [`src/readme.md`](src/readme.md) for the current state.
