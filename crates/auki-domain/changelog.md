...
Tests: red/green `cargo test -p auki-domain --test full_binding_surface native_signaled_domain_peer_surface_is_exposed -- --nocapture`; `cargo test -p auki-domain --lib signaled_peer -- --nocapture`.
