//! Application-facing typed-stream provider and subscription types.
//!
//! These shapes belong to the hosted Domain runtime rather than to the pure
//! wire contract in `auki-protocols`.
