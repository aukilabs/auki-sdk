...
PyO3 bindings for [`auki-layout`](../auki-layout) — pure-function wrappers around the on-disk path helpers. Lets a Python consumer compute SDK-canonical paths without re-implementing the `__`-substitution + directory-name conventions.
