//! Single source of truth for the Auki SDK's log manifests.
//!
...
compile_error!(
    "auki-manifests does not support UniFFI on wasm32; build wasm with --no-default-features --features wasm"
);
