...
- `/auki/stream/0.1.0`, `/auki/info/0.0.1`, `/auki/sensors/0.0.1`, heartbeat, and membership paths are gated against the runtime's current allowed-peer set and silently drop outsiders where appropriate.
