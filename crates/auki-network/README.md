...
- Modules: `swarm`, `network_runtime`, `join_protocol`, `heartbeat_protocol`, `membership_protocol`, `info_protocol`, `resources_protocol`, `resources_v3_protocol`, `message_protocol`, `stream_protocol`, `stream_runtime`, `app_instance`, `discovery_client`
