...
//! Run with:
//! ```sh
//! cargo test -p auki-protocols --features catalog,stream --test locked_json
//! ```

use auki_protocols::catalog::v2::ResourceEntry;
use auki_protocols::stream::v2::StreamRequest;
use std::fs;
use std::path::Path;
