...
PyO3 bindings for [`auki-registry`](../auki-registry) — dict-oriented constructors and hash-pinned on-disk read/write helpers for Sensor, Clock, and Frame Registry entries.
