...
The paged provider contract is [DDS machine inventory pagination](https://github.com/aukilabs/domain-service/blob/feature/385-machine-pagination/docs/machine-inventory-pagination.md).
