...
//!     product_inputs: vec![], observables: vec![], operables: vec![],
//! }.reference();
...
pub use component::{
    ...
    CatalogProductInputEntry, ComponentManifest, ComponentReference, EverySelectedDelivery,
    Exposure, GaugePayloadContract, InMemoryTransport, Invocation, InvocationContext,
    InvocationError, InvocationHandle, InvocationOptions, InvocationOrdering, InvocationStatus,
    ...
    OutputManifest, OutputReference, PayloadContract, PeerRuntime, ProductForm,
    ProductInputBindingManifest, ProductInputContract, ProductManifest, ProductState,
