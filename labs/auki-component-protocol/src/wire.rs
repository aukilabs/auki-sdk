...
use auki_components::{
    CatalogSnapshot, ComponentReference, ObservationEnd, OutputManifest, OutputReference,
    ProductManifest, ProductReference, TimeRangeRequest,
};
...
pub(crate) enum ObservationBatchHeader {
    Accepted {
        ...
        /// For sequence reads, supplied only once the batch reaches the
        /// retained tail. Consumers append the batch before closing readers.
        end: Option<Box<ObservationEnd>>,
    },
    Rejected {
        code: String,
