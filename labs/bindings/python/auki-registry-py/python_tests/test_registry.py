...
Run after building the wheel:
    ...
    maturin develop -m labs/bindings/python/auki-registry-py/Cargo.toml
    pytest labs/bindings/python/auki-registry-py/python_tests/
...
#
# Fixtures live at:
#   labs/auki-registry/tests/locked/<name>.json

_FIXTURES_ROOT = pathlib.Path(__file__).parent.parent.parent.parent.parent.parent / "labs" / "auki-registry" / "tests" / "locked"
