...
const pythonMain = join(workspaceRoot, "labs/examples/standard-protocols/python/main.py");
const pythonManifest = join(workspaceRoot, "core/bindings/python/auki-sdk-py/Cargo.toml");
